 ...
 * We have to, since the OpenAPI generator does not support 3.1.0 properly.
 */
...
public interface VetsApi {
    ...
    default ResponseEntity<VetDto> deleteVet(
        @Parameter(name = "vetId", description = "The ID of the vet.", required = true, in = ParameterIn.PATH) @PathVariable("vetId") String vetId
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<Object> getVet(
        @Parameter(name = "vetId", description = "The ID of the vet.", required = true, in = ParameterIn.PATH) @PathVariable("vetId") String vetId
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
